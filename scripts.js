...
function renderCategory(categoryList, categoryItems) {
    ...
    categories.forEach(function(item, index) {
        if(categoryList === "mobile_category-list") {
            str += `
                <li class="mobile_category-items" data-cateid=${item.categoryID}><a href="" class="mobile_category-link">${item.categoryName}</a></li>
            `;
        }
        else {
            str += `
                <li class="category_items" data-cateid=${item.categoryID}><a href="" class="category_items-link">${item.categoryName}</a></li>
            `;
        }
    })
    list.innerHTML = str;
